      ...
      (a!11 (and ((_ is (Value1 (String) Special_String_Exempt_NA_Null))
                 ...
                 (str.in_re (value Fields.ZipCode)
                            (re.++ (re.range ""0"" ""9"")
                                   ...
                                   (str.to_re ""-"")
                                   a!10))))
      (a!12 (and ((_ is (Value1 (String) Special_String_Exempt_NA_Null))
                   Fields.ZipCode)
                 (str.in_re (value Fields.ZipCode)
                            (re.++ (re.range ""0"" ""9"") a!10)))))
(let ((a!14 (and (or a!11
                     a!12
                     ((_ is (NA () Special_String_Exempt_NA_Null))
                       Fields.ZipCode)
                     ((_ is (Exempt () Special_String_Exempt_NA_Null))
                       Fields.ZipCode))
                 (not a!13))))
  (or (and a!4 (not a!5) a!6 (not a!7) (and a!8 (not a!9)) a!14)
      (and (not a!4) a!5 a!6 (not a!7) (and a!8 (not a!9)) a!14))))))
");
        }
    }
}
